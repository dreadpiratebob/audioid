...
def get_songs(catalog_id:int, song_name:str, song_name_is_an_exact_match:bool, song_year:int, artist_id:int, artist_name:str, artist_name_is_an_exact_match:bool,
  ...
  return get_songs_from_db(catalog_id, song_name, song_name_is_an_exact_match, song_year, artist_id, artist_name, artist_name_is_an_exact_match,
